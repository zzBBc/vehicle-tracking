window.pageMapVehicleTracking = function () {
    ...
    var VehicleTracking = function () {
        ...
        var withView = function (wv) {
            for (var i = 0; i < views.length; i++) wv.bind(this)(views[i]);
        }.bind(this);
        ...
        var viewTracking = function (index, focus) {
                ...
                withView(function (view) {
                    view.viewTracking(tracking, focus);
                });
            }
            .bind(this);
        ...
        this.start = function () {
            ...
            timer.setOption(function (options) {
                options.onTick = function () {
                    ...
                    if (nextIndex >= trackings.length) {
                        currentTrackingIndex = nextIndex;
                        return;
                    };
                    viewTracking(nextIndex, true);
                }
                options.stopWhen = function () {
                    return currentTrackingIndex >= trackings.length - 1;
                };
            });
            timer.start();
        }
    ...
    var TableView = function () {
        ...
        this.onAddVehicleTracking = function () {
            ...
            btnPlay.click(function () {
                $this.vehicleTracking.start();
            });
            btnPause.click(function () {
                $this.vehicleTracking.pause();
            });
            btnReset.click(function () {
                $this.vehicleTracking.stop();
            });
        }
    ...
    var MapView = function () {
        ...
        var directionIcons = [];
        for (var i = 0; i <= 7; i++) {
            vehicleIcons.push(L.icon({
                iconUrl: `img/icons/${i}.png`,
                iconSize: [35, 35]
            }));
            directionIcons.push(L.icon({
                iconUrl: `img/D${i}.png`,
                iconSize: [10, 10]
            }));
        }
        ...
        this.viewTracking = function (tracking, focus) {
            ...
            if (focus) {
                ...
                this.map.panTo(tracking.latLng, {
                    animate: true
                });
            }
        }
...
Core.Timer = function (option) {
    ...
    this.setOption = function (withOption) {
        if (withOption != null) withOption(option);
    };
    ...
    this.start = function () {
        ...
        var interval = typeof (option.interval) == "function" ? option.interval : function () {
