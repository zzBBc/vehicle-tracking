...
(function(){function e(){function e(e){return"\\b([a-z_]|)"+e.replace(/ /g,"(?=:)\\b|\\b([a-z_\\*]|\\*|)")+"(?=:)\\b"}function t(e){return"\\b"+e.replace(/ /g,"(?!-)(?!:)\\b|\\b()")+":\\b"}var n="ascent azimuth background-attachment background-color background-image background-position "+"background-repeat background baseline bbox border-collapse border-color border-spacing border-style border-top "+"border-right border-bottom border-left border-top-color border-right-color border-bottom-color border-left-color "+"border-top-style border-right-style border-bottom-style border-left-style border-top-width border-right-width "+"border-bottom-width border-left-width border-width border bottom cap-height caption-side centerline clear clip color "+"content counter-increment counter-reset cue-after cue-before cue cursor definition-src descent direction display "+"elevation empty-cells float font-size-adjust font-family font-size font-stretch font-style font-variant font-weight font "+"height left letter-spacing line-height list-style-image list-style-position list-style-type list-style margin-top "+"margin-right margin-bottom margin-left margin marker-offset marks mathline max-height max-width min-height min-width orphans "+"outline-color outline-style outline-width outline overflow padding-top padding-right padding-bottom padding-left padding page "+"page-break-after page-break-before page-break-inside pause pause-after pause-before pitch pitch-range play-during position "+"quotes right richness size slope src speak-header speak-numeral speak-punctuation speak speech-rate stemh stemv stress "+"table-layout text-align top text-decoration text-indent text-shadow text-transform unicode-bidi unicode-range units-per-em "+"vertical-align visibility voice-family volume white-space widows width widths word-spacing x-height z-index";var r="above absolute all always aqua armenian attr aural auto avoid baseline behind below bidi-override black blink block blue bold bolder "+"both bottom braille capitalize caption center center-left center-right circle close-quote code collapse compact condensed "+"continuous counter counters crop cross crosshair cursive dashed decimal decimal-leading-zero default digits disc dotted double "+"embed embossed e-resize expanded extra-condensed extra-expanded fantasy far-left far-right fast faster fixed format fuchsia "+"gray green groove handheld hebrew help hidden hide high higher icon inline-table inline inset inside invert italic "+"justify landscape large larger left-side left leftwards level lighter lime line-through list-item local loud lower-alpha "+"lowercase lower-greek lower-latin lower-roman lower low ltr marker maroon medium message-box middle mix move narrower "+"navy ne-resize no-close-quote none no-open-quote no-repeat normal nowrap n-resize nw-resize oblique olive once open-quote outset "+"outside overline pointer portrait pre print projection purple red relative repeat repeat-x repeat-y rgb ridge right right-side "+"rightwards rtl run-in screen scroll semi-condensed semi-expanded separate se-resize show silent silver slower slow "+"small small-caps small-caption smaller soft solid speech spell-out square s-resize static status-bar sub super sw-resize "+"table-caption table-cell table-column table-column-group table-footer-group table-header-group table-row table-row-group teal "+"text-bottom text-top thick thin top transparent tty tv ultra-condensed ultra-expanded underline upper-alpha uppercase upper-latin "+"upper-roman url visible wait white wider w-resize x-fast x-high x-large x-loud x-low x-slow x-small x-soft xx-large xx-small yellow";var i="[mM]onospace [tT]ahoma [vV]erdana [aA]rial [hH]elvetica [sS]ans-serif [sS]erif [cC]ourier mono sans serif";this.regexList=[{regex:SyntaxHighlighter.regexLib.multiLineCComments,css:"comments"},{regex:SyntaxHighlighter.regexLib.doubleQuotedString,css:"string"},{regex:SyntaxHighlighter.regexLib.singleQuotedString,css:"string"},{regex:/\#[a-fA-F0-9]{3,6}/g,css:"value"},{regex:/(-?\d+)(\.\d+)?(px|em|pt|\:|\%|)/g,css:"value"},{regex:/!important/g,css:"color3"},{regex:new RegExp(e(n),"gm"),css:"keyword"},{regex:new RegExp(t(r),"g"),css:"value"},{regex:new RegExp(this.getKeywords(i),"g"),css:"color1"}];this.forHtmlScript({left:/(&lt;|<)\s*style.*?(&gt;|>)/gi,right:/(&lt;|<)\/\s*style\s*(&gt;|>)/gi})}typeof require!="undefined"?SyntaxHighlighter=require("shCore").SyntaxHighlighter:null;e.prototype=new SyntaxHighlighter.Highlighter;e.aliases=["css"];SyntaxHighlighter.brushes.CSS=e;typeof exports!="undefined"?exports.Brush=e:null})();
...
function CoreAjax(typeAction_)
{
    ...
    this.doAjaxHelper = function (methodAjax, dataType, urlRequest, data, callback, onerror, options)
    {
        ...
        }).fail(function (jqXHR, textStatus)
        {
            ...
            if ($this.alertWhenFail) Core.alert("Không thể kết nối tới Server. Vui lòng thử lại", "error");
...
Core.isMobile = function () { var screen_size = Core.getSizeName(); return screen_size == "mobile" || screen_size == "mobile_portrait"; };
Core.isEmail = function (email) { var regex = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/; return regex.test(email); };
Core.isPhoneNumber = function (phone) { var regex = /[0-9\-\(\)\s]+/; return regex.test(phone); };
...
Core.getLabel = function (lexicon) { return lexicon; };
...
$.fn.inputKeypress = function (func, options)
{
	...
	var run = function (input, event, blur)
	{
			...
			else
			{
				...
				if (!blur)
				{
					if (event != null)
					{
						if (event.keyCode == 8)
						{
							if (options.onBackspaceEmpty != null)
								options.onBackspaceEmpty($this);
						}
					}
					else
					{
						if (options.onNoChange != null) options.onNoChange($this);
					}
				}
			}
			t = null;
	...
	if (options.onBlur == null) options.onBlur = function ($this) { run($this, null, true); };
...
$.fn.reBuildLinkHref = function () { return this; };
...
Core.addFbSDK = function ()
{
	...
	if (sdk.length == 0)
	{
		...
		(function (d, s, id)
		{
			...
			js.src = "//connect.facebook.net/" + language + "/sdk.js#xfbml=1&version=v3.2&appId=" + appId;
...
$.fn.getQuery = function () { var query = null; eval("query = " + this.find("[data-query=page]").html()); return query; };
...
PageBase.DefaultPageLoad = function ()
{
	...
	this.runElement = function (element)
	{
		...
		element.find("[data-lazy]").lazyLoadElement({
			onLazy: function (element) {
				var func = element.attr("data-lazy");
				if (func == null || func == "") func = element.attr("data-lazy-func");
				if (func != null && func != "") $this[func](element);				
			}
		});
		//element.thumb(true);
		this.bindControlLoad(element);
		element.bindCmd(this);
	}

	this.bindControlLoad = function (element)
	{
		var $this = this;
	...
	this.loadFbEmbed = function (element) { if (this.ajaxLoading) FB.XFBML.parse(element[0]); };
	this.thumb = function (element)
	{
		element.bind("error", function ()
		{
			...
			else if (eval(target.attr("t")) >= 1)
			{
				target.attr("src", "/Common/Resources/images/noimage.png");
		...
		let srcset = element.attr("data-srcset");
		let srcStyle = element.attr("data-style");

		if ("img" === element[0].tagName.toLowerCase())
		{
			if (src)
			{
				if (srcStyle == "bg") element[0].style.backgroundImage = "url(" + src + ")";
				else element[0].src = src;
			}
			if (srcset) element[0].srcset = srcset;
		}
		else
		{
...
PageBase.reloadPage = function () { $(window).trigger("pathchange"); };
...
function Popup() {
        ...
        if (this.loadContentWhenShow || this.popupBody.html() == "") 
        {
            ...
            if (this.control != "") 
            {
                ...
                ajax.post("LoadModuleByControl", data, function (res)
                {
                    ...
                    var title = $this.popupBody.find("[data-popup-title]").attr("data-popup-title");
                    if (title != null && title != "") $this.setTitle(title);
                });
            }
    ...
    {
        if (this.fullScreen) Core.notify(msg, type, 2000, this.popupBody);
        else Core.notify(msg, type, 2000, this.popupBody);
    }
...
function CoreAlertConfirm(msg, yes, no)
{
    ...
    {        
        popup.popupBody.parents(".modal").addClass("quotation-modal");
        popup.popupBody.parents(".modal-content").addClass("rounded-0");
    };
    popup.show();
    return popup;
}
PageBase.DefaultPageLoadBase = function () { $.extend(this, new PageBase.DefaultPageLoad()); };
PageBase.PageLoad = function ()
{
    ...
    this.onLoad = function ()
    {
        ...
        $(window).off("scroll").scroll(function ()
        {
            ...
            {
                toTop.css({ right: Core.isMobile() ? '38px' : '68px' });
        ...
        if (this.ajaxLoading)
        {
            ...
            $.getScript($("div[data-addthis]").attr("data-addthis"));
        }

        var $this = this;
        $("[data-page-load]").each(function () { var func = $(this).attr("data-page-load"); if (window[func] != null) window[func]($this); });
    };
    this.onBeforeLoad = function ()
    {
        var $this = this;
        $("[data-page-before-load]").each(function () { var func = $(this).attr("data-page-before-load"); if (window[func] != null) window[func]($this); });
    }
    this.loadCarousel = function (element)
    {
        return;
        element.find(".owl-carousel").owlCarousel({ loop: false, margin: 30, autoplay: true, autoplayTimeout: 5000, autoplayHoverPause: true, dots: true, nav: true, responsive: { 0: { items: 1 }, 479: { items: 2 }, 768: { items: 3 }, 991: { items: 2 }, 1024: { items: 3 } } });
    };    
    this.loadCaptchaCode = function (element)
    {
        refreshCaptcha(element, true);
    };
    function refreshCaptcha(element, onLoad)
    {
        if (!onLoad)
        {
            var ajax = new CoreAjax(); ajax.typeAction = "Projects.Web.Controls.CaptchaCode";
            ajax.post("GenerateCaptchaCode",
                {},
                function (res)
                {
                    element.empty();
                    element.append(res.Data.CaptchaCode);
                    element.find('.refresh-captcha').click(function () { $(this).disabledElement(); refreshCaptcha(element, false); $(this).enabledElement(); });
                },
                function (res) { showFancyboxMessage(MessageType.Danger, res.Data.MessageError); }
            );
        }
        else element.find('.refresh-captcha').click(function () { $(this).disabledElement(); refreshCaptcha(element, false); $(this).enabledElement(); });
    }
    this.showPopupContact = function ()
    {
        var $this = this;
        var popup = new Popup();
        popup.module = "PopupContact";
        popup.afterCreatePopupBody = function ()
        {
            popup.footer.hide();
            popup.popupBody.parents(".modal").addClass("quotation-modal");
            popup.popupBody.parents(".modal-content").addClass("rounded-0").addClass("border-0");
        };
        popup.onAlwaysShow = function ()
        {
            popup.popupBody.find(".btn").click(function ()
            {
                var ajax = new CoreAjax(); ajax.typeAction = "Projects.Web.Controls.PopupContact";
                var contact = popup.popupBody.getFormValues();
                contact.SourceLink = window.location.href;
                ajax.post("SaveCallForMe", contact, function (res)
                {
                    var textMes = "<p>" + res.Data.Msg1 + ".<br> " + res.Data.Msg2 + ".</p>";
                    showFancyboxMessage(MessageType.Success, textMes);
                    popup.popupBody.clearFormValues();
                    popup.hide();
                },
                function (res)
                {
                    if (isNullOrWhitespace(res.Data.FieldError))
                        showFancyboxMessage(MessageType.Danger, res.Data.MessageError);
                    var fieldError = popup.popupBody.find("input[name='" + res.Data.FieldError + "'], textarea[name='" + res.Data.FieldError + "']");
                    fieldError.parent("div.form-group, div.form-inline").showInlineMessage(res.Data.MessageError, MessageType.Danger);
                    fieldError.focus();
                });
            });
            $this.bindControlLoad(popup.popupBody);
        }
        popup.show();
    }
    this.fbComment = function (element)
    {
        ...
        Core.runToCondition(function () { if (FB != null) { FB.XFBML.parse(element[0]); return true; }; return false; }, 500);
    }
    this.loadNewsDetail = function (element)
    {
        element.find("img").each(function ()
        {
            $(this).parent().attr("data-src", $(this).attr("src"));
            $(this).parent().attr("data-sub-html", $(this).parent().next("[data-title=image]").html());
        });
        element.lightGallery({ selector: "p[data-image=slide]" });
...
function showFancyboxMessage(msgType, msgContent, bgBodyModal, opts)
{
    ...
    switch (msgType)
    {
        ...
        case MessageType.Info:
            msgIcon = '<p><img src="/Projects/Web/Resources/img/info.svg" alt="info svg" /></p>';
...
function isNullOrWhitespace(input) { return !input || !input.toString().trim(); };
function isSuccessRequest(input) { return !isNullOrWhitespace(input) && input === 200; };
function isBadRequest(input) { return !isNullOrWhitespace(input) && input === 400; };
jQuery.fn.extend({
    ...
    clearFormValues: function () { this.find("input[type='text'][name], input[type='hidden'][name], input[type='password'][name], select[name], textarea[name], input[type='email'][name], input[type='number'][name]").val(''); },
    showInlineMessage: function (msg, type)
    {
        ...
        switch (type)
        {
            case MessageType.Success: this.append('<small class="form-text text-success">' + msg + '</small>'); small = this.find("small"); break;
            case MessageType.Danger: this.append('<small class="form-text text-danger color-red">' + msg + '</small>'); small = this.find("small"); break;
            case MessageType.Warning: this.append('<small class="form-text text-warning">' + msg + '</small>'); small = this.find("small"); break;
            case MessageType.Info: this.append('<small class="form-text text-info">' + msg + '</small>'); small = this.find("small"); break;
        }
        setTimeout(function () { small.remove(); }, 4000);
    },
    disabledElement: function () { this.attr('disabled', 'disabled'); },
    enabledElement: function () { this.removeAttr('disabled'); }
});
